...
- (NSURLSessionDataTask *)vodGetEpisodePeerListByContentGroupId:(NSString *)contentGroupId completion:(void (^)(NSArray *vodDetail, NSError *error))block
{
    ...
    NSString *sUrl = [NSString stringWithFormat:@"%@.xml", CNM_OPEN_API_INTERFACE_getEpisodePeerListByContentGroupId];
    NSDictionary *dict = @{
                           CNM_OPEN_API_VERSION_KEY : CNM_OPEN_API_VERSION,
                           CNM_OPEN_API_TERMINAL_KEY_KEY : [[CMAppManager sharedInstance] getKeychainPrivateTerminalKey],
...
- (NSURLSessionDataTask *)vodGetAssetListByEpisodePeerId:(NSString *)episodePeerId completion:(void (^)(NSArray *vodDetail, NSError *error))block
{
    ...
    NSString *sUrl = [NSString stringWithFormat:@"%@.xml", CNM_OPEN_API_INTERFACE_getAssetListByEpisodePeerId];
    NSDictionary *dict = @{
                           CNM_OPEN_API_VERSION_KEY : CNM_OPEN_API_VERSION,
                           CNM_OPEN_API_TERMINAL_KEY_KEY : [[CMAppManager sharedInstance] getKeychainPrivateTerminalKey],
...
- (NSURLSessionDataTask *)vodGetCouponBalance2Completion:(void (^)(NSArray *vodBuy, NSError *error))block
{
    ...
    NSString *sUrl = [NSString stringWithFormat:@"%@.xml", CNM_OPEN_API_INTERFACE_getCouponBalance2];
    NSDictionary *dict = @{
                           CNM_OPEN_API_VERSION_KEY : CNM_OPEN_API_VERSION,
                           CNM_OPEN_API_TERMINAL_KEY_KEY : [[CMAppManager sharedInstance] getKeychainPrivateTerminalKey],
                           @"domainId" : @"CnM" // 고정
...
- (NSURLSessionDataTask *)vodGetPointBalanceCompletion:(void (^)(NSArray *vodBuy, NSError *error))block
{
    ...
    NSString *sUrl = [NSString stringWithFormat:@"%@.xml", CNM_OPEN_API_INTERFACE_getPointBalance];
    NSDictionary *dict = @{
                           CNM_OPEN_API_VERSION_KEY : CNM_OPEN_API_VERSION,
                           CNM_OPEN_API_TERMINAL_KEY_KEY : [[CMAppManager sharedInstance] getKeychainPrivateTerminalKey],
                           @"domainId" : @"CnM" // 고정
...
- (NSURLSessionDataTask *)myCmDisablePurchaseLogWithPurchaseEventId:(NSString *)purchaseEventId completion:(void (^)(NSArray *myCm, NSError *error))block
{
    ...
    NSString *sUrl = [NSString stringWithFormat:@"%@.xml", CNM_OPEN_API_INTERFACE_disablePurchaseLog];
    NSDictionary *dict = @{
                           CNM_OPEN_API_VERSION_KEY : CNM_OPEN_API_VERSION,
                           CNM_OPEN_API_TERMINAL_KEY_KEY :[[CMAppManager sharedInstance]getKeychainPrivateTerminalKey],
