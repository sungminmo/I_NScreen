...
- (id)initWithFrame:(CGRect)frame itemWidth : (float) itemWidth items : (IDItem *)item, ...{
    ...
    UIImage *defaultBackGroundImage = [UIImage imageNamed:@""];
...
//        _ledge = defaultArchImage.size.height - defaultBackGroundImage.size.height;
        ...
        rect.origin.y = self.frame.size.height - rect.size.height;
        [_backImageView setFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 74)];
...
-(void)createTouchAbleViews{
    ...
    _firstTouchView = [[UIView alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width / 2.f - _archImageView.frame.size.width / 2.f - 20.f, 0, _archImageView.frame.size.width + 40.f, _ledge)];
    ...
    _secondTouchView = [[UIView alloc] initWithFrame:CGRectMake(0, _ledge, [UIScreen mainScreen].bounds.size.width, self.frame.size.height - _ledge)];
