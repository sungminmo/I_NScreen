...
{
    return [[CMNetworkManager sharedInstance] paymentPurchaseAssetEx2WithAssetId:assetId WithProductId:productId WithGoodId:goodId WithPrice:price extraParam:(NSDictionary*)discountParam completion:block];
}
